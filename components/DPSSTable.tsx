...
import { Plus, Trash2, Calendar, AlignLeft, AlignCenter, AlignRight, Highlighter, Type, Settings2, MousePointer2, Minus, Layout, Square, Quote, FileUp, Loader2, Wand2, Menu, ChevronLeft, FileText, ChevronDown, ChevronRight } from 'lucide-react';
