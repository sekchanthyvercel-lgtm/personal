...
import { X, Save, Settings2, Type, Baseline, Paintbrush, Check } from 'lucide-react';
...
export const SettingsModal: React.FC<Props> = ({ isOpen, onClose, settings, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 z-[60] flex items-center justify-center backdrop-blur-md">
      <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-3xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in fade-in zoom-in-95">
